...
public static class BuilderExtensions
{
    ...
    public static void AddMediator(this WebApplicationBuilder builer)
    {
        builer.Services.AddMediatR(x => x.RegisterServicesFromAssemblies(typeof(Configuration).Assembly));
    }
}
